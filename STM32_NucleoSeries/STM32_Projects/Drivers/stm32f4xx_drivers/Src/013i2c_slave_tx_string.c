 ...
 *
 * The master should read and display data from the connected STM32 slave.
 * First, the master has to obtain the length of the data from the slave,
 * then read the subsequent data from the slave.
 *
 * Requirements:
 * 1. Use I2C SCL = 100 kHz (Standard Mode).
 * 2. Use internal pull-up resistors for the SDA and SCL lines.
 */
