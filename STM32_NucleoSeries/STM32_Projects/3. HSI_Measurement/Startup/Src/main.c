/**
  ...
  ******************************************************************************
*/
//#include "stm32f4xx.h"   // Replace with your MCU series header
#include <stdint.h>
...
int main(void)
{
	...
	*pRccCfgrReg &= ~(0x3 << 21); //clear 21 and 22 bit positions
	...
	//Configure MCO1 prescaler (we do it to measure at 8 instead of 24MHz (Logic Analyzer reaches 8MHz max that's why)
	*pRccCfgrReg |= ( 1 << 25);
	*pRccCfgrReg |= ( 1 << 26);
	...
	*pRCCAhb1Enr |= ( 1 << 0); //Enable GPIOA peripheral clock
	...
	//b ) Configure the mode of GPIOA pin 8 as alternate function mode (A, because MCO1 corresponds to PA8 bin in microcontroller)
