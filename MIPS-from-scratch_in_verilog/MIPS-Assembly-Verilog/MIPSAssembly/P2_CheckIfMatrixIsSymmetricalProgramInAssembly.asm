...
# - This program reads a square matrix from the user
#   and checks whether this matrix is symmetric.
# - The input and the checking are performed inside
#   three separate procedures/functions.
# - Problem: I don't know how to free the dynamically
#   allocated memory that I reserve below for the matrix.
